package com.qianf.ly.pandatv.ui.sjLive.animator;
...
public class HeartLayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        mAnimator = new PathAnimator(AbstractPathAnimator.Config.fromTypeArray(a, initX, textHight, pointx, (int) (dWidth*1.5), (int) (dHeight*1.5)));
        a.recycle();
    }
